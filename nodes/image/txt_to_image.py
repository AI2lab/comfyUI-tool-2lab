...
class Txt2Img:
    ...
    def draw_text_in_arc(self, image, draw, text, font, font_path, font_size, center, radius, start_angle, end_angle,
                         fill='black', stroke_fill='blue', stroke_width=0):
        # 文字的总长度
        ...
        for char in text:
            ...
            super_sampling_font = cast(ImageFont.FreeTypeFont,
                                       ImageFont.truetype(font_path, font_size * super_sampling_multiplier))
            char_draw.text((0, 0), char, font=super_sampling_font, fill=fill, stroke_fill=stroke_fill,
    ...
    def doWork(
            self, text, selected_font, align, wrap, font_size, width, height, color, outline_size, outline_color,
            margin_x, margin_y, swap=False, arc_text=False, arc_radius=100, arc_start_angle=180, arc_end_angle=360
    ):
        import textwrap
        ...
        if arc_text:
            ...
            self.draw_text_in_arc(img, draw, text, font, font_path, font_size, center, arc_radius, arc_start_angle,
                                  arc_end_angle,
...
class Txt2ImgMultiline:
    ...
    def doWork(
            self, text, selected_font, align, wrap, graphspace, linespace, font_size, width, height, color,
            outline_size, outline_color, margin_x, margin_y, swap=False
    ):
        from PIL import Image, ImageDraw, ImageFont
        import textwrap
