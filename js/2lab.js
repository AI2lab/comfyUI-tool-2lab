...
//        }
    ...
    //                console.log('message = ',message)
        ...
        if (nodeData.name === "OutputText"+PROJECT_NAME || nodeData.name === "ShowImageSizeAndCount"+PROJECT_NAME ) {
...
//                    console.log('w = ',w)
    ...
    //                console.log('message = ',message)
        ...
        if (nodeData.name === "ShowText"+PROJECT_NAME || nodeData.name === "ShowAny"+PROJECT_NAME) {
            const widgets_count = 1;          // ShowText 初始状态是1个参数
            function populate(text) {
                // 移除在初始状态上增加的widgets
                if (this.widgets) {
